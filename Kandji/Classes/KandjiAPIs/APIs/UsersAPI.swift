...
@objcMembers open class UsersAPI : NSObject {
     ...
     */
    @discardableResult
    open class func getUser(userId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject37?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#9f2a96e0-25c2-4a99-a2e1-7d7a95e75ae6
     ...
     - parameter userId: (path)  
     - returns: RequestBuilder<InlineObject37> 
     */
    open class func getUserWithRequestBuilder(userId: String) -> RequestBuilder<InlineObject37> {
        var localVariablePath = "/api/v1/users/{user_id}"
        let userIdPreEscape = "\(APIHelper.mapValueToPathItem(userId))"
        let userIdPostEscape = userIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{user_id}", with: userIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject37>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listUsers(email: String? = nil, _id: String? = nil, integrationId: String? = nil, archived: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject36?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#b107eb0a-b586-414f-bc4c-3d2b304cfd5f
     ...
     - parameter integrationId: (query) Search for a integration matching the provided UUID value. (optional)
     - parameter archived: (query) Return only users that are either archived (true) or not archived (false). Archived users are users that appear in the Kandji Users module under the Archived tab. (optional)
     - returns: RequestBuilder<InlineObject36> 
     */
    open class func listUsersWithRequestBuilder(email: String? = nil, _id: String? = nil, integrationId: String? = nil, archived: String? = nil) -> RequestBuilder<InlineObject36> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject36>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
