...
@objcMembers open class TagsAPI : NSObject {
     ...
     */
    @discardableResult
    open class func createTag(body: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success201Response1?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#f9270517-98cb-4078-99b3-cbcd1acc2fca
     ...
     - parameter body: (body)  (optional)
     - returns: RequestBuilder<Success201Response1> 
     */
    open class func createTagWithRequestBuilder(body: String? = nil) -> RequestBuilder<Success201Response1> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Success201Response1>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getTags(search: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success200Response?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func getTagsWithRequestBuilder(search: String) -> RequestBuilder<Success200Response> {
        let localVariablePath = "/api/v1/tags"
        let localVariableURLString = kandji_sdkAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @discardableResult
    open class func updateTag(tagId: String, body: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success200Response14?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#9ab6d414-42da-4628-9261-e58ce2e61465
     ...
     - parameter tagId: (path)  
     - parameter body: (body)  (optional)
     - returns: RequestBuilder<Success200Response14> 
     */
    open class func updateTagWithRequestBuilder(tagId: String, body: String? = nil) -> RequestBuilder<Success200Response14> {
        var localVariablePath = "/api/v1/tags/{tag_id}"
        let tagIdPreEscape = "\(APIHelper.mapValueToPathItem(tagId))"
        let tagIdPostEscape = tagIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{tag_id}", with: tagIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<Success200Response14>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
