...
@objcMembers open class LibraryItemsAPI : NSObject {
     ...
     */
    @discardableResult
    open class func getLibraryItemActivity(libraryItemId: String, activityType: String? = nil, userId: String? = nil, userEmail: String? = nil, limit: String? = nil, offset: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject2?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func getLibraryItemActivityWithRequestBuilder(libraryItemId: String, activityType: String? = nil, userId: String? = nil, userEmail: String? = nil, limit: String? = nil, offset: String? = nil) -> RequestBuilder<InlineObject2> {
     ...
     */
    @discardableResult
    open class func getLibraryItemStatuses(libraryItemId: String, computerId: String? = nil, limit: String? = nil, offset: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject2?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#478764c4-638c-416c-b44c-3685a2f7b441
     ...
     - returns: RequestBuilder<InlineObject2> 
     */
    open class func getLibraryItemStatusesWithRequestBuilder(libraryItemId: String, computerId: String? = nil, limit: String? = nil, offset: String? = nil) -> RequestBuilder<InlineObject2> {
