...
@objcMembers open class BlueprintsAPI : NSObject {
     ...
     */
    @discardableResult
    open class func createBlueprint(name: String, enrollmentCodeIsActive: String, enrollmentCodeCode: String, sourceType: String, sourceId: String, type: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success201Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#8ee421a2-c1f8-41ba-9285-8db1b33e092d
     ...
     - parameter sourceId: (form) Set either the source template ID, or the source Blueprint ID to clone an existing template or blueprint. 
     - parameter type: (form) Choose the type of blueprint to create. Options: &lt;code&gt;classic&lt;/code&gt; or &lt;code&gt;map&lt;/code&gt; 
     - returns: RequestBuilder<Success201Response> 
     */
    open class func createBlueprintWithRequestBuilder(name: String, enrollmentCodeIsActive: String, enrollmentCodeCode: String, sourceType: String, sourceId: String, type: String) -> RequestBuilder<Success201Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Success201Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getBlueprint(blueprintId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success200Response2?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#c0383706-3a41-445c-998f-37a2c1c7ba4a
     ...
     - parameter blueprintId: (path)  
     - returns: RequestBuilder<Success200Response2> 
     */
    open class func getBlueprintWithRequestBuilder(blueprintId: String) -> RequestBuilder<Success200Response2> {
        var localVariablePath = "/api/v1/blueprints/{blueprint_id}"
        let blueprintIdPreEscape = "\(APIHelper.mapValueToPathItem(blueprintId))"
        let blueprintIdPostEscape = blueprintIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{blueprint_id}", with: blueprintIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<Success200Response2>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func listBlueprints(_id: String? = nil, idIn: String? = nil, name: String? = nil, limit: String? = nil, offset: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success200Response?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func listBlueprintsWithRequestBuilder(_id: String? = nil, idIn: String? = nil, name: String? = nil, limit: String? = nil, offset: String? = nil) -> RequestBuilder<Success200Response> {
        let localVariablePath = "/api/v1/blueprints"
        let localVariableURLString = kandji_sdkAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @discardableResult
    open class func listLibraryItems(blueprintId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#34af40a5-7273-425c-9ea5-2c8a5dbbe29f
     ...
     - returns: RequestBuilder<Success200Response> 
     */
    open class func listLibraryItemsWithRequestBuilder(blueprintId: String) -> RequestBuilder<Success200Response> {
     ...
     */
    @discardableResult
    open class func updateBlueprint(blueprintId: String, name: String, _description: String, enrollmentCodeCode: String, enrollmentCodeIsActive: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: Success200Response3?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#4820ba50-291a-4857-b622-77a9ab9cc9e3
     ...
     - parameter enrollmentCodeCode: (form) Update the enrollment code of the Blueprint  
     - parameter enrollmentCodeIsActive: (form) Disable the Blueprint for manual device enrollment from the enrollment portal. 
     - returns: RequestBuilder<Success200Response3> 
     */
    open class func updateBlueprintWithRequestBuilder(blueprintId: String, name: String, _description: String, enrollmentCodeCode: String, enrollmentCodeIsActive: String) -> RequestBuilder<Success200Response3> {
        var localVariablePath = "/api/v1/blueprints/{blueprint_id}"
        let blueprintIdPreEscape = "\(APIHelper.mapValueToPathItem(blueprintId))"
        let blueprintIdPostEscape = blueprintIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{blueprint_id}", with: blueprintIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<Success200Response3>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
