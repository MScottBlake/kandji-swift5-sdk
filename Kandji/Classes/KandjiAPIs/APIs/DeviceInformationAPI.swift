...
@objcMembers open class DeviceInformationAPI : NSObject {
     ...
     */
    @discardableResult
    open class func getDevice(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: GetIpad200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#10a56208-b230-455a-a835-32b6cfb2803d
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<GetIpad200Response> 
     */
    open class func getDeviceWithRequestBuilder(deviceId: String) -> RequestBuilder<GetIpad200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetIpad200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceActivity(deviceId: String, limit: String, offset: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: GetDeviceActivity200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#80710108-fbdb-4dfd-af84-50adf15c5a23
     ...
     - parameter limit: (query) A hard upper &lt;code&gt;limit&lt;/code&gt; is set at 300 device records returned per request. If more device records are expected, pagination should be used using the &lt;code&gt;limit&lt;/code&gt; and &lt;code&gt;offset&lt;/code&gt; parameters. Additionally, parameter queries can be added to a request to limit the results. 
     - parameter offset: (query) Specify the starting record to return (optional)
     - returns: RequestBuilder<GetDeviceActivity200Response> 
     */
    open class func getDeviceActivityWithRequestBuilder(deviceId: String, limit: String, offset: String? = nil) -> RequestBuilder<GetDeviceActivity200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetDeviceActivity200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceApps(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: IpadApps200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#f8cd9733-89b6-40f0-a7ca-76829c6974df
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<IpadApps200Response> 
     */
    open class func getDeviceAppsWithRequestBuilder(deviceId: String) -> RequestBuilder<IpadApps200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<IpadApps200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceDetails(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: IphoneOrIpadInLostMode200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#efa2170d-e5f7-4b97-8f4c-da6f84ba58b5
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<IphoneOrIpadInLostMode200Response> 
     */
    open class func getDeviceDetailsWithRequestBuilder(deviceId: String) -> RequestBuilder<IphoneOrIpadInLostMode200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<IphoneOrIpadInLostMode200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceLibraryItems(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: EdrStatus200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#005bf79f-3458-4834-9c2f-4e0c792069f4
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<EdrStatus200Response> 
     */
    open class func getDeviceLibraryItemsWithRequestBuilder(deviceId: String) -> RequestBuilder<EdrStatus200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<EdrStatus200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceLostModeDetails(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: GetDeviceLostModeDetails200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#e1f5550e-3c6c-43fa-a1d0-dccc1635bae6
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<GetDeviceLostModeDetails200Response> 
     */
    open class func getDeviceLostModeDetailsWithRequestBuilder(deviceId: String) -> RequestBuilder<GetDeviceLostModeDetails200Response> {
        var localVariablePath = "/api/v1/devices/{device_id}/details/lostmode"
        let deviceIdPreEscape = "\(APIHelper.mapValueToPathItem(deviceId))"
        let deviceIdPostEscape = deviceIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{device_id}", with: deviceIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<GetDeviceLostModeDetails200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceParameters(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: GetDeviceParameters200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#8ca8c0e9-654e-40c1-8d8c-c9a8a6e262c6
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<GetDeviceParameters200Response> 
     */
    open class func getDeviceParametersWithRequestBuilder(deviceId: String) -> RequestBuilder<GetDeviceParameters200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetDeviceParameters200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceStatus(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: GetDeviceStatus200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#93f2cf60-cd3b-47ff-8388-2377fbff3c6e
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<GetDeviceStatus200Response> 
     */
    open class func getDeviceStatusWithRequestBuilder(deviceId: String) -> RequestBuilder<GetDeviceStatus200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetDeviceStatus200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func updateDevice(deviceId: String, body: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: ClearAllTags200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#b70f2ddc-cc1b-4b4f-8eec-e481d8a17927
     ...
     - parameter deviceId: (path)  
     - parameter body: (body)  (optional)
     - returns: RequestBuilder<ClearAllTags200Response> 
     */
    open class func updateDeviceWithRequestBuilder(deviceId: String, body: String? = nil) -> RequestBuilder<ClearAllTags200Response> {
        var localVariablePath = "/api/v1/devices/{device_id}"
        let deviceIdPreEscape = "\(APIHelper.mapValueToPathItem(deviceId))"
        let deviceIdPostEscape = deviceIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{device_id}", with: deviceIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<ClearAllTags200Response>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
