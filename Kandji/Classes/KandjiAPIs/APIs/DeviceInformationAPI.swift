...
@objcMembers open class DeviceInformationAPI : NSObject {
     ...
     */
    @discardableResult
    open class func getDevice(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject8?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#10a56208-b230-455a-a835-32b6cfb2803d
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<InlineObject8> 
     */
    open class func getDeviceWithRequestBuilder(deviceId: String) -> RequestBuilder<InlineObject8> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject8>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceActivity(deviceId: String, limit: String, offset: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject12?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#80710108-fbdb-4dfd-af84-50adf15c5a23
     ...
     - parameter limit: (query) A hard upper &lt;code&gt;limit&lt;/code&gt; is set at 300 device records returned per request. If more device records are expected, pagination should be used using the &lt;code&gt;limit&lt;/code&gt; and &lt;code&gt;offset&lt;/code&gt; parameters. Additionally, parameter queries can be added to a request to limit the results. 
     - parameter offset: (query) Specify the starting record to return (optional)
     - returns: RequestBuilder<InlineObject12> 
     */
    open class func getDeviceActivityWithRequestBuilder(deviceId: String, limit: String, offset: String? = nil) -> RequestBuilder<InlineObject12> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject12>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceApps(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject13?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#f8cd9733-89b6-40f0-a7ca-76829c6974df
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<InlineObject13> 
     */
    open class func getDeviceAppsWithRequestBuilder(deviceId: String) -> RequestBuilder<InlineObject13> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject13>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceDetails(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject10?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#efa2170d-e5f7-4b97-8f4c-da6f84ba58b5
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<InlineObject10> 
     */
    open class func getDeviceDetailsWithRequestBuilder(deviceId: String) -> RequestBuilder<InlineObject10> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject10>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceLibraryItems(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject14?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#005bf79f-3458-4834-9c2f-4e0c792069f4
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<InlineObject14> 
     */
    open class func getDeviceLibraryItemsWithRequestBuilder(deviceId: String) -> RequestBuilder<InlineObject14> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject14>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceLostModeDetails(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject11?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#e1f5550e-3c6c-43fa-a1d0-dccc1635bae6
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<InlineObject11> 
     */
    open class func getDeviceLostModeDetailsWithRequestBuilder(deviceId: String) -> RequestBuilder<InlineObject11> {
        var localVariablePath = "/api/v1/devices/{device_id}/details/lostmode"
        let deviceIdPreEscape = "\(APIHelper.mapValueToPathItem(deviceId))"
        let deviceIdPostEscape = deviceIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{device_id}", with: deviceIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject11>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceParameters(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject15?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#8ca8c0e9-654e-40c1-8d8c-c9a8a6e262c6
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<InlineObject15> 
     */
    open class func getDeviceParametersWithRequestBuilder(deviceId: String) -> RequestBuilder<InlineObject15> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject15>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getDeviceStatus(deviceId: String, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject16?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#93f2cf60-cd3b-47ff-8388-2377fbff3c6e
     ...
     - parameter deviceId: (path)  
     - returns: RequestBuilder<InlineObject16> 
     */
    open class func getDeviceStatusWithRequestBuilder(deviceId: String) -> RequestBuilder<InlineObject16> {
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject16>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func updateDevice(deviceId: String, body: String? = nil, apiResponseQueue: DispatchQueue = kandji_sdkAPI.apiResponseQueue, completion: @escaping ((_ data: InlineObject9?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#b70f2ddc-cc1b-4b4f-8eec-e481d8a17927
     ...
     - parameter deviceId: (path)  
     - parameter body: (body)  (optional)
     - returns: RequestBuilder<InlineObject9> 
     */
    open class func updateDeviceWithRequestBuilder(deviceId: String, body: String? = nil) -> RequestBuilder<InlineObject9> {
        var localVariablePath = "/api/v1/devices/{device_id}"
        let deviceIdPreEscape = "\(APIHelper.mapValueToPathItem(deviceId))"
        let deviceIdPostEscape = deviceIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{device_id}", with: deviceIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<InlineObject9>.Type = kandji_sdkAPI.requestBuilderFactory.getBuilder()
