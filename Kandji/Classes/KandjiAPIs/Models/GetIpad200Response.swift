...
@available(*, deprecated, renamed: "kandji_sdkAPI.GetIpad200Response")
public typealias GetIpad200Response = kandji_sdkAPI.GetIpad200Response

extension kandji_sdkAPI {

@objcMembers public class GetIpad200Response: NSObject, Codable, JSONEncodable {
    ...
    public var user: GetIpad200ResponseUser?
    ...
    public init(deviceId: String? = nil, deviceName: String? = nil, model: String? = nil, serialNumber: String? = nil, platform: String? = nil, osVersion: String? = nil, supplementalBuildVersion: String? = nil, supplementalOsVersionExtra: String? = nil, lastCheckIn: String? = nil, user: GetIpad200ResponseUser? = nil, assetTag: String? = nil, blueprintId: String? = nil, mdmEnabled: Int? = nil, agentInstalled: Int? = nil, isMissing: Int? = nil, isRemoved: Int? = nil, agentVersion: String? = nil, firstEnrollment: String? = nil, lastEnrollment: String? = nil, blueprintName: String? = nil, tags: AnyCodable? = nil) {
