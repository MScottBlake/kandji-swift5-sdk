...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject37")
public typealias InlineObject37 = kandji_sdkAPI.InlineObject37

extension kandji_sdkAPI {

@objcMembers public class InlineObject37: NSObject, Codable, JSONEncodable {
    ...
    public var integration: InlineObject37Integration?
    ...
    public init(active: Int? = nil, archived: Int? = nil, createdAt: String? = nil, department: AnyCodable? = nil, deprecatedUserId: String? = nil, email: String? = nil, _id: String? = nil, integration: InlineObject37Integration? = nil, jobTitle: AnyCodable? = nil, name: String? = nil, deviceCount: Int? = nil, updatedAt: String? = nil) {
        self.active = active
...
extension kandji_sdkAPI.InlineObject37: Identifiable {}
