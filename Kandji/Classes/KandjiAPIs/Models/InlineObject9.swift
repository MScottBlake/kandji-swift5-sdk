...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject9")
public typealias InlineObject9 = kandji_sdkAPI.InlineObject9

extension kandji_sdkAPI {

@objcMembers public class InlineObject9: NSObject, Codable, JSONEncodable {
