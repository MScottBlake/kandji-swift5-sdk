...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject4")
public typealias InlineObject4 = kandji_sdkAPI.InlineObject4

extension kandji_sdkAPI {

@objcMembers public class InlineObject4: NSObject, Codable, JSONEncodable {

    public var blueprintId: String?
    public var mdmDevice: InlineObject4MdmDevice?
    public var userId: String?
    public var depAccount: InlineObject4DepAccount?
...
extension kandji_sdkAPI.InlineObject4: Identifiable {}
