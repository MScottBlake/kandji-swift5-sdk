...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject10Mdm")
public typealias InlineObject10Mdm = kandji_sdkAPI.InlineObject10Mdm

extension kandji_sdkAPI {

@objcMembers public class InlineObject10Mdm: NSObject, Codable, JSONEncodable {
