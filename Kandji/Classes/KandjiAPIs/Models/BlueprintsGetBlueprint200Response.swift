...
@objcMembers public class BlueprintsGetBlueprint200Response: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: String? = nil, name: String? = nil, icon: String? = nil, color: String? = nil, _description: String? = nil, params: AnyCodable? = nil, computersCount: Int? = nil, enrollmentCode: BlueprintsCreateBlueprint201ResponseEnrollmentCode? = nil, type: String? = nil) {
        self._id = _id
        self.name = name
        self.icon = icon
        self.color = color
