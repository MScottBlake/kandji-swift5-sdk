...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject10General")
public typealias InlineObject10General = kandji_sdkAPI.InlineObject10General

extension kandji_sdkAPI {

@objcMembers public class InlineObject10General: NSObject, Codable, JSONEncodable {
