...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject7")
public typealias InlineObject7 = kandji_sdkAPI.InlineObject7

extension kandji_sdkAPI {

@objcMembers public class InlineObject7: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: String? = nil, name: String? = nil, icon: String? = nil, color: String? = nil, _description: String? = nil, params: AnyCodable? = nil, computersCount: Int? = nil, missingComputersCount: Int? = nil, enrollmentCode: InlineObject5EnrollmentCode? = nil) {
        self._id = _id
        self.name = name
        self.icon = icon
        self.color = color
...
extension kandji_sdkAPI.InlineObject7: Identifiable {}
