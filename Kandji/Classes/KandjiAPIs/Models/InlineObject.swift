...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject")
public typealias InlineObject = kandji_sdkAPI.InlineObject

extension kandji_sdkAPI {

@objcMembers public class InlineObject: NSObject, Codable, JSONEncodable {

    public var _id: String?
    public var blueprint: InlineObjectBlueprint?
    ...
    public var defaults: InlineObjectDefaults?
    ...
    public var deviceCounts: InlineObjectDeviceCounts?

    public init(_id: String? = nil, blueprint: InlineObjectBlueprint? = nil, accessTokenExpiry: String? = nil, serverName: String? = nil, serverUuid: String? = nil, adminId: String? = nil, orgName: String? = nil, orgEmail: String? = nil, orgPhone: String? = nil, orgAddress: String? = nil, orgType: String? = nil, stokenFileName: String? = nil, lastDeviceSync: AnyCodable? = nil, defaults: InlineObjectDefaults? = nil, daysLeft: Int? = nil, status: String? = nil, statusReason: AnyCodable? = nil, statusReceivedAt: AnyCodable? = nil, deviceCounts: InlineObjectDeviceCounts? = nil) {
        self._id = _id
...
extension kandji_sdkAPI.InlineObject: Identifiable {}
