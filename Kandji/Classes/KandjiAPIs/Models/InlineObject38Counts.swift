...
@available(*, deprecated, renamed: "kandji_sdkAPI.InlineObject38Counts")
public typealias InlineObject38Counts = kandji_sdkAPI.InlineObject38Counts

extension kandji_sdkAPI {

@objcMembers public class InlineObject38Counts: NSObject, Codable, JSONEncodable {
