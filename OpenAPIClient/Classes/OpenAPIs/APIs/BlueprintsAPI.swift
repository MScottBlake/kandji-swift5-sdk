...
open class BlueprintsAPI {
     ...
     */
    @discardableResult
    open class func assignLibraryItem(blueprintId: String, body: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func createBlueprint(enrollmentCodeCode: String, enrollmentCodeIsActive: String, name: String, sourceId: String, sourceType: String, type: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    url: https://api-docs.kandji.io/#8ee421a2-c1f8-41ba-9285-8db1b33e092d
     ...
     - returns: RequestBuilder<AnyCodable> 
     */
    open class func createBlueprintWithRequestBuilder(enrollmentCodeCode: String, enrollmentCodeIsActive: String, name: String, sourceId: String, sourceType: String, type: String) -> RequestBuilder<AnyCodable> {
     ...
     */
    @discardableResult
    open class func deleteBlueprint(blueprintId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getBlueprint(blueprintId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getBlueprintTemplates(limit: String? = nil, offset: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getManualEnrollmentProfile(blueprintId: String, sso: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: String?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - parameter id: (query) Look up a specific Blueprint by its ID (optional)
     ...
     */
    @discardableResult
    open class func listBlueprints(id: String? = nil, idIn: String? = nil, name: String? = nil, limit: String? = nil, offset: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
        return listBlueprintsWithRequestBuilder(id: id, idIn: idIn, name: name, limit: limit, offset: offset).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    url: https://api-docs.kandji.io/#44d3765c-ef17-4226-9104-47e5cef1d370
     ...
     - returns: RequestBuilder<AnyCodable> 
     */
    open class func listBlueprintsWithRequestBuilder(id: String? = nil, idIn: String? = nil, name: String? = nil, limit: String? = nil, offset: String? = nil) -> RequestBuilder<AnyCodable> {
        let localVariablePath = "/api/v1/blueprints"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @discardableResult
    open class func listLibraryItems(blueprintId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func removeLibraryItem(blueprintId: String, body: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - parameter blueprintId: (path)  
     - parameter description: (form) Update the description of the Blueprint  
     ...
     */
    @discardableResult
    open class func updateBlueprint(blueprintId: String, description: String, enrollmentCodeCode: String, enrollmentCodeIsActive: String, name: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
        return updateBlueprintWithRequestBuilder(blueprintId: blueprintId, description: description, enrollmentCodeCode: enrollmentCodeCode, enrollmentCodeIsActive: enrollmentCodeIsActive, name: name).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    url: https://api-docs.kandji.io/#4820ba50-291a-4857-b622-77a9ab9cc9e3
     ...
     - returns: RequestBuilder<AnyCodable> 
     */
    open class func updateBlueprintWithRequestBuilder(blueprintId: String, description: String, enrollmentCodeCode: String, enrollmentCodeIsActive: String, name: String) -> RequestBuilder<AnyCodable> {
        var localVariablePath = "/api/v1/blueprints/{blueprint_id}"
        let blueprintIdPreEscape = "\(APIHelper.mapValueToPathItem(blueprintId))"
        let blueprintIdPostEscape = blueprintIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{blueprint_id}", with: blueprintIdPostEscape, options: .literal, range: nil)
