...
open class UsersAPI {
     ...
     */
    @discardableResult
    open class func getUser(userId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - parameter id: (query) Search for a user matching the provided UUID value. (optional)
     ...
     */
    @discardableResult
    open class func listUsers(email: String? = nil, id: String? = nil, integrationId: String? = nil, archived: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
        return listUsersWithRequestBuilder(email: email, id: id, integrationId: integrationId, archived: archived).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    url: https://api-docs.kandji.io/#b107eb0a-b586-414f-bc4c-3d2b304cfd5f
     ...
     - returns: RequestBuilder<AnyCodable> 
     */
    open class func listUsersWithRequestBuilder(email: String? = nil, id: String? = nil, integrationId: String? = nil, archived: String? = nil) -> RequestBuilder<AnyCodable> {
