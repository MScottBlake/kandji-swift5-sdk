...
# **getUser**
```swift
    open class func getUser(userId: String, completion: @escaping (_ data: Success200Response16?, _ error: Error?) -> Void)
```
...
# **listUsers**
```swift
    open class func listUsers(email: String? = nil, _id: String? = nil, integrationId: String? = nil, archived: String? = nil, completion: @escaping (_ data: Success200Response15?, _ error: Error?) -> Void)
```
