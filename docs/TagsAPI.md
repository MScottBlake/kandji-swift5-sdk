...
# **createTag**
```swift
    open class func createTag(body: String? = nil, completion: @escaping (_ data: InlineObject31?, _ error: Error?) -> Void)
```
...
# **getTags**
```swift
    open class func getTags(search: String, completion: @escaping (_ data: InlineObject2?, _ error: Error?) -> Void)
```
...
# **updateTag**
```swift
    open class func updateTag(tagId: String, body: String? = nil, completion: @escaping (_ data: InlineObject31?, _ error: Error?) -> Void)
```
